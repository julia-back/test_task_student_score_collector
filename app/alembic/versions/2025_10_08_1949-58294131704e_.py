...
def upgrade() -> None:
    ...
    op.create_foreign_key(
        op.f("fk_scores_user_id_users"), "scores", "users", ["user_id"], ["id"]
    )
...
def downgrade() -> None:
    ...
    op.add_column(
        "scores",
        sa.Column(
            "user_owner", sa.INTEGER(), autoincrement=False, nullable=False
        ),
    )
    op.drop_constraint(
        op.f("fk_scores_user_id_users"), "scores", type_="foreignkey"
    )
    op.create_foreign_key(
